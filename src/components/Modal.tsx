...
function Modal({ isOpen, setIsOpen, onClose }: ModalProps) {
  ...
  return (
    <aside className="absolute flex justify-center text-center px-20  py-2 after:top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 right-0 bottom-0 w-[50%] max-w-3/4 h-[50%] border-solid border-black bg-primary-color-200 text-white overflow-y-scroll z-10000">
      <button
      ...
      <div>
        ...
        <h2 className="pt-5 text-xl">Here is a quick summary of the app</h2>
        ...
        <section>
          <ul>
            <li className="h-8 border-black p-0 m-0">
              <p>
